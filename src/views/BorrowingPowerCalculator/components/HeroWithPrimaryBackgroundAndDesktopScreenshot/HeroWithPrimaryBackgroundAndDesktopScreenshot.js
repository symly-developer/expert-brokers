        ...
        <Grid container spacing={4}>
          <Grid item container alignItems={'center'} xs={12} md={6}>
            <Box>
              ...
              >
                Calculate your borrowing power with out quick calculator. Talk to us to check if there are any other levers that we can pull to increase your borrowing power or get you the best rate.
              </Typography>
              {/* <Box
                display="flex"
                flexWrap="wrap"
