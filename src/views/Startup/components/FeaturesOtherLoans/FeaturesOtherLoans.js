          ...
          <Box>
            <Box marginBottom={2}>
              <Typography component={'h2'} variant={'h4'} sx={{ fontWeight: 700 }} gutterBottom>
                Any other loan ? We help you secure finances for your next big project.
              </Typography>
              <Typography color="text.secondary">
                We provide a range of financial services to help you secure the right loan for your needs. Whether you're looking for a personal loan, commercial loan, or asset finance, we have the expertise to guide you through the process and find the best solution for your unique situation.
              </Typography>
            </Box>
...
export default FeaturesOtherLoans;
