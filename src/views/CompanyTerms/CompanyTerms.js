...
const CompanyTerms = () => {
  ...
  return (
    <Main>
      {/* <Helmet
        title="Terms & Privacy Policy at Cash Capital"
        description="Read the terms and privacy policy of Cash Capital. We are the best in the business when it comes to investment loans."
        link={'/company-terms'}
        keywords={''}
        ...
        <Box boxShadow={4} borderRadius={2}>
          <Box bgcolor={theme.palette.primary.main} borderRadius={2}>
            <Container paddingX={{ xs: 2, sm: 4 }}>
              ...
              >
                Last modified on <strong>12 Feb, 2025</strong>
              </Typography>
            </Container>
            <Box
              component={'svg'}
