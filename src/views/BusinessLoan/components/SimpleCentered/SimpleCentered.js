        ...
        <Box marginBottom={4}>
          <Box marginBottom={2}>
            ...
            <Typography
              ...
              align={'left'}
            >
              Our finance brokers are experts in making sure your business loan is set up to maximise your investment.  With access to hundreds of different business loans, we can help you find flexible business loans for:
              <ul>
                <li>Business working capital</li>
                <li>Buying a new business or franchise</li>
                <li>Buying or investing in commercial property</li>
                <li>Residential and commercial property development</li>
